...
$(document).ready(function(){
    $("input#status_option").click(function(){
        var status_option = $(this).is(':checked');
        var id = $(this).parents('#option').find('input[id="id"]').val();
        // alert(status);
        $.ajax({
            url:  'admin/ajax/update_status_option/'+id, type: 'GET', cache: false, data: {
...
$(document).ready(function(){
    $("button#button_option").click(function(){
        var id = $(this).parents('#section').find('input[id="id"]').val();
        // alert(id);
        $.ajax({
            url:  'admin/ajax/dell_section/'+id, type: 'GET', cache: false, data: {
                "id":id
            },
        });
    });
...
$(document).ready(function(){
    $( "select.button_submit" ).change(function() {
        $( "#submit" ).submit();
    });
}); // submit form
